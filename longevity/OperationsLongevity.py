...
def install_validator():
    ...
    val="k2cyber/k2-intcode-agent:validator-"+validator
    ...
    script_path = "/root/kishan/v2-install-scripts"   
    stdin, stdout, stderr = con.exec_command("bash "+script_path+"/install-db.sh")   # Install DB
    ...
    try:
        ...
        console_border()
        print(stdout.read().decode("utf8").split("\n"))
        console_border()
    except:
        print("error in showing containers !")
...
def show_containers():
    try:
       ...
       print("\nError occured in showing running container on with machine.\033[0m \n")
       #quit() 
